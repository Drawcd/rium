...
<div id="iyke_form">
	<div class="iyke_form-title"><h2>상담신청</h2> <h3>contact</h3></div>
	...
	<div class="icenter">
		<select name="wr_2" class="input1" required itemname="상담선택">
			<option value="시행문의" <? php if ($write[wr_2]=="") echo "selected"; ?>시행문의</option>
	...
	<div class="iclear"></div>
	<div class="icenter"><input type=button id="ibtn_submit" value="상담신청"></div>
	<div class="iright"></div>
