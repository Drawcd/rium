  ...
  <div class="section-group padding-tb-80 text-center">
    ...
    <ul class="section-list col-md-12 col-xs-12 rium-concept">
      <li class="col-md-4 col-xs-4 rium-concept-list ">
        <h4 class="rium-concept-list-title">“전문성”</h4>
        <h5 class="rium-concept-list-title-sub">professionalism</h5>
        <h4 class="rium-concept-list-text">신뢰를 바탕으로 이뤄진 종합 부동산 그룹회사로 시행,설계,시공에서 분양에 이르기까지 전문적인 컨설팅과 사업제안이 가능합니다.</h4>
      </li>
      <li class="col-md-4 col-xs-4 rium-concept-list">
        <h4 class="rium-concept-list-title">연속성</h4>
        <h5 class="rium-concept-list-title-sub">continuity</h5>
        <h4 class="rium-concept-list-text">체계적인 업무진행으로 기간을 단축시키고 리스크를 줄일수 있으며, 시작부터 마무리까지 책임지고 성공적인 사업이 되도록 이끌어 드리겠습니다.</h4>
      </li>
      <li class="col-md-4 col-xs-4 rium-concept-list">
        <h4 class="rium-concept-list-title">안정성</h4>
        <h5 class="rium-concept-list-title-sub">stability</h5>
        <h4 class="rium-concept-list-text">인간적인 기업을 만들겠다는 이념으로 시작한 리움은 고객님과의 믿음과 신뢰를 지키고 늘 책임감 있는 자세로 업무에 충실 하겠습니다.</h4>
      </li>
    </ul>
  </div>
</div>
