<ul class="section-wrap padding-zero">
  <li class="size-three-two-one section-wrap-item animate" data-animate="fadeIn" data-duration="1.0s" data-delay="0.1s" data-offset="100">
    <div class="section-wrap-list ">
      ...
      <div class="button02">
        <a href="#button02" class="button-link" target="_self">자세히보기</a>
      </div>
    </div>
  </li>
  <li class="size-three-two-one section-wrap-item animate" data-animate="fadeIn" data-duration="1.0s" data-delay="0.1s" data-offset="100">
    <div class="section-wrap-list">
      <div class="section-wrap-list-text">
        ...
        <h3>건축설계</h3>
        <p>차별화된 설계와 디자인으로 고객님의 건축물에 가치를 만들어 드립니다.</p>
      </div>
      <div class="button02">
        <a href="#button02" class="button-link" target="_self">자세히보기</a>
      </div>
  ...
  <li class="size-three-two-one section-wrap-item animate" data-animate="fadeIn" data-duration="1.0s" data-delay="0.1s" data-offset="100">
    <div class="section-wrap-list">
        <div class="section-wrap-list-text">
          ...
          <h3>건축시공</h3>
          <p>단독주택부터 공동주택,상업용건축물까지 최고의 품질로 답해 드리겠습니다.</p>
        </div>
        <div class="button02">
          <a href="#button02" class="button-link" target="_self">자세히보기</a>
        </div>
  ...
  <li class="size-three-two-one section-wrap-item animate" data-animate="fadeIn" data-duration="1.0s" data-delay="0.1s" data-offset="100">
    <div class="section-wrap-list ">
      <div class="section-wrap-list-text">
        ...
        <p>고객님의 입장에서 전문가의 눈높이를 가지고 부동산 자산의 가치를 지켜드립니다.</p>
      </div>
        <div class="button02 bottom-10">
          <a href="#button02" class="button-link" target="_self">자세히보기</a>
        </div>
    </div>
  </li>
  ...
  <li class="size-three-two-one section-wrap-item animate" data-animate="fadeIn" data-duration="1.0s" data-delay="0.1s" data-offset="100">
    <div class="section-wrap-list ">
      <div class="section-wrap-list-text">
        <h3>Housing Sale Agency</h3>
        <h3>분양에이전시</h3>
        <p>직영분양, 직대행분양, 대행분양을 갖춘 유일한 기업</p>
      </div>
    </div>
  </li>
</ul>
