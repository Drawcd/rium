...
<?php } ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="wr_1">연락처</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="wr_2">상담선택</label>
		<div class="col-sm-6">
		<select name="wr_2" class="form-control input-sm" required itemname="상담선택">
			<option value="홈페이지제작" <? if ($write[wr_2]=="") echo "selected"; ?>>홈페이지제작</option>
			<option value="모바일홈제작" <? if ($write[wr_2]=="창업문의") echo "selected"; ?>>모바일홈제작</option>
