...
if(USE_G5_THEME && defined('G5_THEME_PATH')) {
    require_once(G5_THEME_PATH.'/tail_board.php');
    return;
}
...
if(APMS_PIM || $is_layout_sub) {
	@include_once(THEMA_PATH.'/tail.sub_board.php');
	include_once(G5_PATH.'/tail.sub_board.php');
	return;
}

if(IS_SHOP) {
	if(file_exists(THEMA_PATH.'/shop.tail_board.php')) {
		include_once(THEMA_PATH.'/shop.tail_board.php');
	} else {
		include_once(THEMA_PATH.'/tail_board.php');
	}
} else {
	if(file_exists(THEMA_PATH.'/tail_board.php')) {
		include_once(THEMA_PATH.'/tail_board.php');
	} else {
		include_once(THEMA_PATH.'/shop.tail_board.php');
	}
