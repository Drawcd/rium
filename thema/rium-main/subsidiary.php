    ...
    <div id="p-design">
      <div id="p-cnc">
        <div class="section-select">
          <ul class="section-select-list list-style-none">
            <li class="section-select-item">
              <a href="#p-wdc">
                <img src="/img/main/w.png" alt="">
                <img src="/img/main/w-1.png" alt="">
              </a>
            </li>
            <li class="section-select-item">
              <a href="#p-thekenc">
                <img src="/img/main/thek.png" alt="">
                <img src="/img/main/thek-1.png" alt="">
              </a>
            </li>
            <li class="section-select-item">
              <a href="#p-design">
                <img src="/img/main/tn-1.png" alt="">
                <img src="/img/main/tn-1.png" alt="">
              </a>
            </li>
            <li class="section-select-item">
              <a href="#p-cnc">
                <img src="/img/main/cnc-1.png" alt="">
                <img src="/img/main/cnc-1.png" alt="">
              </a>
            </li>
          </ul>
...
<!-- 페이지 내용 -->
        <div id="subsidiary-page" class="subsidiary-page">
          <div class="c-page" id="wdc">
            <div class="wdc wrap">
              <div class="col-lg-4 wdc-left c-page-left">
              </div>
              <div class="col-lg-8 wdc-right c-page-right">
                <!-- section-title start -->
                <div class="at-container">
                  <div class="section-title">
                    ...
                    <div class="section-text">
                      <h4 class="service-joint-business-list-item-title inline-block">시행사업에는 믿을 수 있는 파트너가 필요 합니다.</h4>
                      <h4 class="service-joint-business-list-item-sub-text">
                        시행에서 시작해서 종합부동산 그룹으로 성장하기 까지 많은 시련과 위기를 극복하였기에 고객님이 걱정하시는 부분에 대하여
                         누구보다 자신있게 말씀드릴 수 있습니다.<br>
                         사업의 성공을 위해 마지막 하나까지 "신의"를 지키고 함께 할 수 있는 리움을 선택하시면 최고의 답을 제시하여 드리겠습니다.
                      </h4>
                    </div>
                  </div>
                </div>
          ...
          <div class="c-page" id="thekenc">
            <div class="thekenc wrap">
              <!-- <div class="col-lg-4 thekenc-left c-page-left">
              </div> -->
              <div class="col-lg-12 thekenc-right c-page-right">
                <!-- section-title start -->
                <div class="at-container">
                  <div class="section-title">
                    ...
                    <div class="section-text">
                      <h4 class="service-joint-business-list-item-title inline-block">전문 협력사들과의 협력을 통하여 각자 자신의 맡은 공정에 대하여 최선을 다하고 있습니다.</h4>
                      <h4 class="service-joint-business-list-item-sub-text">
                        건축에 있어서 고객님들의 공통적인 관심사 는 대부분 완성도 높은 시공과 비용이 였습니다. <br>
                        저희 리움에서는 고객님들의 그러한 요구를 적극 방영하여 그동안 효율성을 연구해왔으며, 사업성에 완성도를 높혀 드리기 위하여 비용문제에 있어서 만큼은...
                         고객님과의 신뢰를 지키기 위해 적정의 견적 만을 고집하고 있습니다.<br>
                         그리고 완벽한 시공을 위해 오랜 시간동안 함께 해왔던 전문 기업들이 있었기에 가능 하였으며, 그렇게 쌓인 노하우로
                         고객님의 신뢰에 완성도 높은 건축물로 보답하고 있습니다.
                      </h4>
                    </div>
                    <div class="section-img">
                    </div>
