...
<!-- sidebar Box -->
<aside id="sidebar-box" class="animate <?php echo (isset($at_set['font']) && $at_set['font']) ? $at_set['font'] : 'ko';?>" data-animate="bounceIn" data-duration="1.0s" data-delay="0.1s" data-offset="30">
