...
<aside id="sidebar-box" class="clearfix <?php echo (isset($at_set['font']) && $at_set['font']) ? $at_set['font'] : 'ko';?>">

	<!-- sidebar Wing -->
	<div class="sidebar-wing">
		<!-- sidebar Wing Close -->
    <ul class="sidebar-menu-item clearfix">
			<li class="sidebar-menu-list sidebar-wing-close en" title="닫기" onClick="sideBarWrap.sideMenubtn(this);" data-action-type="hide"><i class="fa fa-times"></i></li>
			<li class="sidebar-menu-list sidebar-wing-close en" title="홈"><a href="<?php echo $at_href['home']; ?>"><i class="fa fa-home"></i></a></li>
			<?php if ($is_admin) { ?>
				<li class="sidebar-menu-list sidebar-wing-close en" title="내정보"><i class="fa fa-user"></i></li>
				<?php if(IS_YC) { // 영카트 이용시 ?>
					<?php if(IS_SHOP) { // 영카트 이용시 ?>
					<?php } else { ?>
						<li class="sidebar-menu-list sidebar-wing-close en" title="장바구니"><i class="fa fa-shopping-bag"></i></li>
				<?php } ?><?php } ?>
				<li class="sidebar-menu-list sidebar-wing-close en" title="알림"><i class="fa fa-bell"></i></li>
				<li class="sidebar-menu-list sidebar-wing-close en" title="검색"><i class="fa fa-search"></i></li>
			<?php } ?>
    </ul>
	</div>

	<!-- sidebar Content -->
	<div id="sidebar-content" class="sidebar-content bg-<?php echo $line_top;?>">
		<!-- Head Line -->
		...
		<div class="sidebar-common">
			...
			<div class="btn-group btn-group-justified" role="group">
				...
				<?php } else { ?>
					...
					<a href="<?php echo $at_href['lost'];?>" class="win_password_lost btn btn-navy btn-sm">아이디/비밀번호 찾기</a>
