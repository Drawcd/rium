						...
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<input type="text" class="form-control input-sm" name="at_set[size]" value="<?php echo $at_set['size'];?>" placeholder="1310">
						...
						<div id="swSet<?php echo $toggle;?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="swHead<?php echo $toggle;?>">
							<div class="panel-body">
								...
								<div class="input-group input-group-sm input-bottom">
									...
									<input type="text" class="form-control input-sm" name="at_set[mh]" value="<?php echo $at_set['mh'];?>" placeholder="60">
									<span class="input-group-addon">px</span>
								</div>
