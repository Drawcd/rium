...
<div id="thema_wrapper" class="wrapper animated <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>" data-animate-effect="fadeIn">
  ...
  <div class="at-menu-bg-margin"></div>
	...
	<div class="at-body resize-height gradient-bg">
		<?php if($col_name) { ?>
			<div class="at-container">
			<?php if($col_name == "two") { ?>
